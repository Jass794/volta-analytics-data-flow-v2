...
events_report = BashOperator(
    task_id='events_report',
    bash_command=f"source {venv_path}/bin/activate && cd /opt/airflow/dags/volta-analytics-data-flow && python main.py events_report {os.getenv('SERVER')}",
    dag=dag,
)

# Set task dependencies
check_venv_task >> create_venv_task >> install_deps_task >> events_report
